(function ($) {
    ...
    $.easyui = (function () {
        //获取弹出窗口数据集合
        function getDialogs() {
            var dialogs = $top("#div_index_data").data("dialogs");
            dialogs = dialogs || [];
        ...
        function addDialog(id) {
            ...
            $top("#div_index_data").data("dialogs", data);
        }
        ...
        return {
            ...
            dialog: function (options) {
                ...
                function createDialow() {
                    return $top("<div id='" + options.id + "'></div>").appendTo('body');
                }
                ...
                function show() {
                    dialog.dialog({
                        ...
                        onLoad: function () {
                            var win = $top("#" + options.id).window("window");
                            $top("#" + options.buttons).addClass("dialog-button").appendTo(win);
                            $.easyui.initControls($top);
                        },
                        onClose: function () {
                            options.closeCallback();
                            $top("#" + getCurrentDialogId()).dialog('destroy');
                            removeCurrentDialog();
                        }
                    });
                }
            ...
            confirm: function (msg, callback, title) {
                ...
                ///	标题
                ///	</param>
                $.tts.confirm(title || "确认", msg, function (result) {
                    if (result)
                        callback();
                });
            },
            //初始化控件
            initControls: function (jQuery$) {
                jQuery$ = jQuery$ || $;
                jQuery$("table.easyui-datagrid-edit").edatagrid();
                jQuery$("table.easyui-treegrid-edit").etreegrid();
            }
        };
    })();
})(jQuery);
